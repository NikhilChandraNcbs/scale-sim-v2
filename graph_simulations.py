...
output_csv_path = "output_results_vith.csv"
output_plot_path = "lws_compute_cycles_plot_vith.png"
...
def main():
    ...
    if generate_graphs:
        ...
        # csv_files = ["output_results_vits.csv", "output_results_vitb.csv", "output_results_vitl.csv", "output_results_vith.csv"]
        # plot_results_combined_stacked(csv_files, "lws_vit_sblh.png")
