...
class systolic_compute_ws:
    ...
    def set_params(self,
        ...
        # print("self.row_fold_demand_matrices", self.row_fold_demand_matrices)
    ...
    def create_filter_demand_mat(self):
        ...
        #     print(self.filter_demand_matrix)
        # assert 1==0, "STOP"
        # null_req_mat = np.ones((self.ifmap_demand_matrix.shape[0] - self.filter_demand_matrix.shape[0], self.filter_demand_matrix.shape[1])) * -1
        # print(self.filter_demand_matrix.shape)
