...
class single_layer_sim:
    ...
    def run(self):
        ...
        print("self.num_compute = self.topo.get_layer_num_ofmap_px(self.layer_id) * self.topo.get_layer_window_size(self.layer_id)")
        print("Nofmap: Number of OFMAP pixels generated by filter")
        print(self.num_compute, "=", self.topo.get_layer_num_ofmap_px(self.layer_id), "*", self.topo.get_layer_window_size(self.layer_id))
        print("self.layer_id ", self.layer_id)
