...
template_cfg = '''# python scalesim/scale.py -c configs/myconfigs{arraysize}_alexnet/{run_name}.cfg -t topologies/conv_nets/{model}.csv -p sparsesim/sparsity_results_{arraysize}_alexnet > {run_name}.txt
[general]
