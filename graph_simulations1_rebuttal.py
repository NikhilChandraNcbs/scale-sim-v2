...
#         if args.stage == '1a':
#             output_csv_path = f"output_results_{args.model}.csv"
#             output_plot_path = f"compute_cycles_plot_{args.model}.png"
#             use_fixed_cfg = False
#         else:  # stage 1b
#             output_csv_path = f"rws_output_results_{args.model}.csv"
#             output_plot_path = f"rws_compute_cycles_plot_{args.model}.png"
#             use_fixed_cfg = True # this is force it to use 32x32 always
...
#         output_plot_path = "overlapping_compute_cycles_scatter_vits_rebuttal.png"
...
def main():
    ...
    if args.stage in ['1a', '1b']:
        ...
        generate_graphs = True
        output_csv_path = ""  # Not used in stage 2
        output_plot_path = "compute_cycles_scatterplot.png"
        use_fixed_cfg = False  # Not relevant in stage 2
